'use strict'
import { getUsuarios, deleteAluno, createUsuario, updateUsuario } from "./main.js";
...
const formatarDataBrasil = (dataOriginal) => {
...
const criarCard = (usuario) => {
    ...
    dataNascimentoUsuario.textContent = formatarDataBrasil(usuario.data_nascimento);
    ...
    editarUsuario.src = "./images/editar.png";
    ...
    editarUsuario.addEventListener('click', () => {
        ...
        buttonEditar.addEventListener('click', () => {
            ...
            if (nome.value == "" || nome.value == null) {
              ...
              updateUsuario(usuario.id, usuarioJSON);
              setTimeout(function () {
                location.reload();
              }, 1000);
            }
    ...
    excluirUsuario.src = "./images/excluir.png";
